...
public class FollowUpService {
	...
	public FollowUp save(final FollowUp followUp, final Article article) {
		...
		Assert.isTrue(this.newsPaperService.findNewspaperByArticle(article.getId()).getPublicationDate().before(new Date()));//Comprueba que el peri�dico  ha sido publicado
